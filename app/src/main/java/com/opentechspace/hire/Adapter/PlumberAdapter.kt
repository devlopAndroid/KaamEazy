...
class PlumberAdapter(private val context: Context, val list : List<ItemPlumberModel>,
                     val onItemClickListener: OnPlumbersItemClickListener)
    : RecyclerView.Adapter<PlumberAdapter.myViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: myViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onItemClickListener.onPlumberClickItem(result.Title!!)
        }
    }
...
interface OnPlumbersItemClickListener{
    fun onPlumberClickItem(title : String)
}
