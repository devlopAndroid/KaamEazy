...
class CleaningAdapter(private val context: Context, val list : List<ItemCleaningModel>,
                     val onItemClickListener: OnCleaningItemClickListener)
    : RecyclerView.Adapter<CleaningAdapter.myViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: myViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onItemClickListener.onCleaningClickItem(result.Title!!)
        }
    }
...
interface OnCleaningItemClickListener{
    fun onCleaningClickItem(title : String)
}
